...
public class CompanyValidator {
    ...
    public void validate(CompanyCreateRequest companyCreateRequest){
        legalName(companyCreateRequest.legalName(), errors);
        phoneNumber(companyCreateRequest.phoneNumber(), errors);
        email(companyCreateRequest.email(), errors);
        cnpjCpf(companyCreateRequest.cnpjCpf(), errors);
